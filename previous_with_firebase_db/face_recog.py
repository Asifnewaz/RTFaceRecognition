...
while True:
    ...
    imgS = cv2.resize(img, (160, 120))  # Directly resize to the smaller size
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                imageName= "Images/" + str(id) + ".png"
                imgStudent = cv2.imread(imageName)
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    if imgStudent is not None:
                        ...
                        print("Warning: imgStudent is None.")
...
#                 cv2.putText(imgBackground, text, (x1, y1), font, font_scale, font_color, font_thickness,
#                             cv2.LINE_AA)
#
#
#     else:
